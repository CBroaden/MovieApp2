  ...
  return (
    <div className="flex flex-col gap-8 items-center ">
      <div className="flex flex-col gap-2 justify-center items-center">
        ...
        <div  className="flex flex-col gap-4 justify-center items-center w-full md:w-3/5  p-6">
          <Link href={`/moviedetails/${movies[0].id}`} className="hover:scale-105 duration-700">
